...
# configuration of the various factors to render. Modify as necessary, the following is a complete list
...
"""
Possible choices for properties:
"object_type": ["cube", "sphere", "cylinder", "cone", "torus"],
"color": ["red", "blue", "yellow", "purple", "orange"],
"size": can be adjusted freely,
"rotation": can be adjusted freely from 0 to 90,
}
"""
