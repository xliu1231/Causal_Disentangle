...
def _h_A(A, m):
    A_square = A * A
    x = torch.eye(m) + torch.div(A_squre, m)
...
def parse():
    ...
    parser.add_argument("--model", default="causalvae", type=str,
    ...
    parser.add_argument('--num-concepts', default=4, type=int)
    parser.add_argument('--dim-per-concept', default=32, type=int)
