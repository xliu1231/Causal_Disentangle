...
train_dataset = CandleDataset(data_path="/cmlscratch/margot98/Causal_Disentangle/candle simulator/images",
                              attr_path='CANDLE_label.txt',
                              attr=['cube','sphere'],
                              transform=transform)

train_dataset = entangled_Candle(data_path="/cmlscratch/margot98/Causal_Disentangle/candle-simulator/images",
