...
from codebase import utils as ut
from codebase.mask_vae_flow import CausalVAE_IOSS
import argparse
from pprint import pprint
# cuda = torch.cuda.is_available()
...
# args = parser.parse_args() # exception occurs: unrecognized arguments
...
lvae = CausalVAE_IOSS(name=model_name, z_dim=16).to(device)
...
# dataset_dir = '/Users/jiaxinyuan/CausalVAE/causal_data/causal_data'
